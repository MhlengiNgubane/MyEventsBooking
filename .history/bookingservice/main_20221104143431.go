...
import (
	...
	"github.com/mhlengi/MyEvents/cmd/msgqueue"
	msgqueue_amqp "github.com/mhlengi/MyEvents/cmd/msgqueue/amqp"
	"github.com/mhlengi/MyEvents/cmd/msgqueue/kafka"
...
func main() {
	...
	x := listener.EventProcessor{EventListener: eventListener, Database: dbhandler}
	processor := x
